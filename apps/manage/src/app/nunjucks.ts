...
export function configureNunjucks(): nunjucks.Environment {
	...
	// get the path to the @pins/appeals-migration-lib folder, in node_modules, using the node require resolution
	const libUi = path.resolve(require.resolve('@pins/appeals-migration-lib'), '..');
