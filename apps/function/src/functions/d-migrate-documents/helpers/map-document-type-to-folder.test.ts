...
describe('mapHorizonDocumentTypeAndFolder', () => {
	test('maps confirmed Horizon types to appellant-case folder', () => {
		...
		assert.strictEqual(result.folderPath, 'appellant-case/originalApplicationForm');
	});
	...
	test('maps confirmed Horizon types to lpa-questionnaire folder', () => {
		...
		assert.strictEqual(result.folderPath, 'lpa-questionnaire/consultationResponses');
	});
	...
	test('maps confirmed Horizon types to costs folder', () => {
		...
		assert.strictEqual(result.folderPath, 'costs/appellantCostsApplication');
	});
	...
	test('maps confirmed Horizon types to internal folder', () => {
		...
		assert.strictEqual(result.folderPath, 'internal/mainPartyCorrespondence');
	});
	...
	test('defaults unmapped Horizon types to UNCATEGORISED with warning', () => {
		...
		assert.strictEqual(result.folderPath, 'internal/uncategorised');
