...
type FolderPath =
	| typeof APPEAL_CASE_STAGE.APPELLANT_CASE
	| typeof APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE
	| 'representation'
	| typeof APPEAL_CASE_STAGE.CANCELLATION
	| typeof APPEAL_CASE_STAGE.COSTS
	| typeof APPEAL_CASE_STAGE.INTERNAL
	| typeof APPEAL_CASE_STAGE.APPEAL_DECISION;
...
const DOCUMENT_TYPE_TO_FOLDER: Record<AppealDocumentType, FolderPath> = {
	...
	[APPEAL_DOCUMENT_TYPE.APPELLANT_STATEMENT]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.ORIGINAL_APPLICATION_FORM]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.APPLICATION_DECISION_LETTER]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.CHANGED_DESCRIPTION]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.APPELLANT_CASE_WITHDRAWAL_LETTER]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.APPELLANT_CASE_CORRESPONDENCE]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.DESIGN_ACCESS_STATEMENT]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.PLANS_DRAWINGS]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.NEW_PLANS_DRAWINGS]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.PLANNING_OBLIGATION]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.OWNERSHIP_CERTIFICATE]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.OTHER_NEW_DOCUMENTS]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.ENVIRONMENTAL_ASSESSMENT]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.STATEMENT_COMMON_GROUND]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.PRIOR_CORRESPONDENCE_WITH_PINS]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.ENFORCEMENT_NOTICE]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.ENFORCEMENT_NOTICE_PLAN]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_A_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_B_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_C_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_D_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_E_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_F_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_G_SUPPORTING]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.GROUND_A_FEE_RECEIPT]: APPEAL_CASE_STAGE.APPELLANT_CASE,
	[APPEAL_DOCUMENT_TYPE.EIA_ENVIRONMENTAL_STATEMENT_APPELLANT]: APPEAL_CASE_STAGE.APPELLANT_CASE,

	// lpa-questionnaire folder
	[APPEAL_DOCUMENT_TYPE.WHO_NOTIFIED]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.WHO_NOTIFIED_SITE_NOTICE]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.WHO_NOTIFIED_LETTER_TO_NEIGHBOURS]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.WHO_NOTIFIED_PRESS_ADVERT]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.CONSERVATION_MAP]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.OTHER_PARTY_REPRESENTATIONS]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.PLANNING_OFFICER_REPORT]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.DEVELOPMENT_PLAN_POLICIES]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.TREE_PRESERVATION_PLAN]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.DEFINITIVE_MAP_STATEMENT]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.COMMUNITY_INFRASTRUCTURE_LEVY]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.SUPPLEMENTARY_PLANNING]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.EMERGING_PLAN]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.CONSULTATION_RESPONSES]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.EIA_ENVIRONMENTAL_STATEMENT]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.EIA_SCREENING_OPINION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.EIA_SCOPING_OPINION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.EIA_SCREENING_DIRECTION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.LPA_CASE_CORRESPONDENCE]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.OTHER_RELEVANT_POLICIES]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.APPEAL_NOTIFICATION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.HISTORIC_ENGLAND_CONSULTATION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.RELATED_APPLICATIONS]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.STOP_NOTICE]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.ARTICLE_4_DIRECTION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.ENFORCEMENT_LIST]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.LOCAL_DEVELOPMENT_ORDER]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.PLANNING_PERMISSION]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.LPA_ENFORCEMENT_NOTICE]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.LPA_ENFORCEMENT_NOTICE_PLAN]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.PLANNING_CONTRAVENTION_NOTICE]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.OTHER_RELEVANT_MATTERS]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.ADDITIONAL_DOCUMENTS_LPA]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.DESIGN_ACCESS_STATEMENT_LPA]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,
	[APPEAL_DOCUMENT_TYPE.PLANS_DRAWINGS_LPA]: APPEAL_CASE_STAGE.LPA_QUESTIONNAIRE,

	// costs folder
	[APPEAL_DOCUMENT_TYPE.APPELLANT_COSTS_APPLICATION]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.APPELLANT_COSTS_WITHDRAWAL]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.APPELLANT_COSTS_CORRESPONDENCE]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.LPA_COSTS_APPLICATION]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.LPA_COSTS_WITHDRAWAL]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.LPA_COSTS_CORRESPONDENCE]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.APPELLANT_COSTS_DECISION_LETTER]: APPEAL_CASE_STAGE.COSTS,
	[APPEAL_DOCUMENT_TYPE.LPA_COSTS_DECISION_LETTER]: APPEAL_CASE_STAGE.COSTS,

	// internal folder
	[APPEAL_DOCUMENT_TYPE.CROSS_TEAM_CORRESPONDENCE]: APPEAL_CASE_STAGE.INTERNAL,
	[APPEAL_DOCUMENT_TYPE.INSPECTOR_CORRESPONDENCE]: APPEAL_CASE_STAGE.INTERNAL,
	[APPEAL_DOCUMENT_TYPE.MAIN_PARTY_CORRESPONDENCE]: APPEAL_CASE_STAGE.INTERNAL,
	[APPEAL_DOCUMENT_TYPE.UNCATEGORISED]: APPEAL_CASE_STAGE.INTERNAL,

	// appeal-decision folder
	[APPEAL_DOCUMENT_TYPE.CASE_DECISION_LETTER]: APPEAL_CASE_STAGE.APPEAL_DECISION,
