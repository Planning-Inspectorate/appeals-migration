...
const LPA_QUESTIONNAIRE_DOCUMENT_TYPES = [
	...
	APPEAL_DOCUMENT_TYPE.OTHER_RELEVANT_MATTERS
];
...
const CANCELLATION_DOCUMENT_TYPES = [APPEAL_DOCUMENT_TYPE.LPA_ENFORCEMENT_NOTICE_WITHDRAWAL];
...
export const FOLDERS: string[] = [
	...
	...CANCELLATION_DOCUMENT_TYPES.map((docType) => `${APPEAL_CASE_STAGE.CANCELLATION}/${docType}`),
