...
resource "azurerm_mssql_database" "primary" {
  # checkov:skip=CKV_AZURE_229: Zone Redundant Not available for DTU pricing
  # checkov:skip=CKV_AZURE_224: Ledger not required
...
resource "azurerm_key_vault_secret" "sql_admin_connection_string" {
  # checkov:skip=CKV_AZURE_41: secret rotation - TODO: replace with Entra ID authentication
